...
ifeq (clang-cl, $(TOOLCHAIN_TYPE))
	CONFIGURE_ARGS += 'CC=clang-cl'
	CONFIGURE_ARGS += 'CXX=clang-cl'
else
...
ifeq (clang-cl, $(TOOLCHAIN_TYPE))
	CONFIGURE_ARGS += 'OMR_TOOLCHAIN=clang-cl'
	CONFIGURE_ARGS += 'OMR_BUILD_TOOLCHAIN=clang-cl'
else
	CONFIGURE_ARGS += 'OMR_TOOLCHAIN=msvc'
	CONFIGURE_ARGS += 'OMR_BUILD_TOOLCHAIN=msvc'
endif
